...
public class MovieGridFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		/*As i display unlimited number of movies*/
	...
	public void onSaveInstanceState(Bundle outState) {
		//Sve the list item selected  position
	...
	public class FetchMovieTask extends AsyncTask<String, Void, ArrayList<Movie>> {
		...
		protected ArrayList<Movie> doInBackground(String... params) {
			...
			try {
				...
				MovieNowJsonStr = buffer.toString();
			...
			try {
				return getMovieDataFromJson(MovieNowJsonStr, 20);
		...
		public ArrayList<Movie> getMovieDataFromJson(String MovieNowJsonStr, int numMovie)
				throws JSONException {
			final String RESULTS = "results";
			final String ID = "id";
			final String POSTER_PATH = "poster_path";
			JSONObject movieJson = new JSONObject(MovieNowJsonStr);
		...
		public class ImageAdapter extends ArrayAdapter<Movie> {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				Picasso.with(getContext())
						...
						.error(R.drawable.backgroundwithtext)
						.fit()
						.into(view);
				return view;
			}
